...
class ApparentTempLineChart extends StatelessWidget {
  const ApparentTempLineChart({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    if (WeatherData != null) {
      ...
      final hourlyData = WeatherData['hourly']['apparent_temperature'] as List;
                    ...
                    child: SfCartesianChart(
                      ...
                      series: <CartesianSeries>[
                        LineSeries<_AqiData, int>(
                          ...
                          width: 5,
                          color: const Color.fromARGB(255, 255, 190, 152),
                          markerSettings: const MarkerSettings(
                              isVisible: true,
                              color: Color.fromARGB(255, 255, 131, 68)),
