...
class DewPointLineChart extends StatelessWidget {
  const DewPointLineChart({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    if (WeatherData != null) {
      ...
      final hourlyData = WeatherData['hourly']['dew_point_2m'] as List;
                    ...
                    child: SfCartesianChart(
                      ...
                      series: <CartesianSeries>[
                        LineSeries<_AqiData, int>(
                          ...
                          name: 'Dew',
                          width: 5,
                          color: const Color.fromARGB(255, 118, 171, 172),
