...
class Pm25BarChart extends StatelessWidget {
  const Pm25BarChart({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    if (airQualityData != null &&
      ...
      final hourlyData = airQualityData['hourly']['pm2_5'] as List;
                    ...
                    child: SfCartesianChart(
                      ...
                      series: <CartesianSeries>[
                        ColumnSeries<_AqiData, int>(
                          ...
                          name: 'AQI (PM 2.5)',
                          width: 0.6,
                          color: const Color.fromARGB(255, 105, 177, 188),
